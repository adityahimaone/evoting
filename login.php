...
body {
  img src="foto/back1.jpg" alt="gambar" class="big"
...
<body background="foto/mp-02.png"> 
<div class="login" >
  <header class="login-header"><span class="text"><font face="Helvetica">LOGIN</span><span class="loader"></span></header>
  <form class="login-form" action="proses_login_admin.php" method="POST">
